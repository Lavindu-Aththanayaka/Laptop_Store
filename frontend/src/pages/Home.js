...
const Home = () => {
  return (
    <div>
      ...
      <VerticalCardProduct
        category={"ACER ASPIRE GO 15"}
        heading={"ACER ASPIRE GO 15"}
      />
      <VerticalCardProduct
        category={"MICROSOFT SURFACE LAPTOP"}
        heading={"MICROSOFT SURFACE LAPTOP"}
      />
      <VerticalCardProduct
        category={"DELL XPS 13 (2024)"}
        heading={"DELL XPS 13 (2024)"}
      />
      <VerticalCardProduct
        category={"SAMSUNG GALAXY BOOK4"}
        heading={"SAMSUNG GALAXY BOOK4"}
      />
    </div>
  );
};
